...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                // ExampleQuery::class,
                'suggestions' => App\GraphQL\Queries\SuggestionsQuery::class,
                'favorites' => App\GraphQL\Queries\FavoritesQuery::class,
            ],
            'mutation' => [
                // ExampleMutation::class,
                'addFavorite' => App\GraphQL\Mutations\AddFavoriteMutation::class,
                'removeFavorite' => App\GraphQL\Mutations\RemoveFavoriteMutation::class,
            ],
    ...
    'types' => [
        ...
        'Lyric' => App\GraphQL\Types\LyricType::class,
        'Favorite' => App\GraphQL\Types\FavoriteType::class,
    ],
